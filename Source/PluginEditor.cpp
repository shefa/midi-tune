...
MidiTuneAudioProcessorEditor::MidiTuneAudioProcessorEditor (MidiTuneAudioProcessor& p)
...
MidiTuneAudioProcessorEditor::~MidiTuneAudioProcessorEditor()
{
}

//==============================================================================

void MidiTuneAudioProcessorEditor::paint (Graphics& g)
{
    g.fillAll (getLookAndFeel().findColour (ResizableWindow::backgroundColourId));
}

void MidiTuneAudioProcessorEditor::resized()
{
